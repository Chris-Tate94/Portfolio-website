...
const data = [
  {
    ...
    description: 'Hosted on Hostinger, this fully responsive and dynamic portfolio site showcases projects that I created or collaborated on. I decided to build this site with React as I enjoyed the streamlined process of building and styling components individually. This helped me keep the project organized, easy to edit or revise, and update any components as needed.',
  ...
  },
  {
    ...
    image: homePage,
    title: 'Scheduler',
    description: "This Lighthouse Labs project was an introduction to React and is intended to get bootcamp students comfortable with using React to develop interactive UI's. Creating various components and passing props, state and functions throughout to create a seamless user environment. We also utilized Storybook for isolated component building and Cypress for end-to-end testing.",
